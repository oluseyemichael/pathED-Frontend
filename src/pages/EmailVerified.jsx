...
const EmailVerified = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 font-aeonik-bold">
      <img src="src/assets/logo.svg" alt="PathED" className='mb-24'/>
